...
const stats = [
  { value: "80+", label: "MVRE Systems Installed", icon: <Zap className="w-5 h-5" />, color: "#20B0E0" },
  { value: "60%", label: "Energy Savings vs MEE", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "150+", label: "MLD Concentrated", icon: <Droplets className="w-5 h-5" />, color: "#0E84B8" },
  { value: "99%", label: "Water Recovery", icon: <Award className="w-5 h-5" />, color: "#E0B040" },
];
...
const keyFeatures = [
  {
    title: "High Energy Efficiency Through Vapor Recompression",
    description: "Reuses process vapor as heating medium, minimizing energy waste",
    color: "#20B0E0",
  },
  {
    title: "Minimal External Steam Requirement",
    description: "Mechanical compression eliminates the need for large steam boilers",
    color: "#0E84B8",
  },
  {
    title: "Continuous and Automated Operation",
    description: "PLC-controlled for unattended, 24/7 operation",
    color: "#8CC63F",
  },
  {
    title: "Compact Footprint with Lower Operating Cost",
    description: "Smaller installation space and reduced utility expenses",
    color: "#E0B040",
  },
  {
    title: "Substantially Lower Operating Cost Compared to MEE",
    description: "Energy savings of up to 60% over conventional evaporators",
    color: "#0E84B8",
  },
  {
    title: "High Water Recovery with Consistent Performance",
    description: "Reliable distillate quality for reuse applications",
    color: "#20B0E0",
  },
];
...
const applications = [
  "Industrial ZLD plants with high wastewater volumes",
  "RO reject concentration",
  "Industries seeking energy-optimized evaporation solutions",
];

/* ─────────────────────── Component ─────────────────────── */

export default function MvreSystemPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">MVRE System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">MVRE</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/mvre-system-content.avif" type="image/avif" />
                  <source srcSet="/mvre-system-content.webp" type="image/webp" />
                  <img
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">80+</p>
                    <p className="text-xs text-[#3C4D57]">MVRE Systems Installed</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Our MVRE System</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Energy-Efficient Vapor{" "}
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Mechanical Vapor Recompression Evaporator (MVRE) is an energy-efficient
                evaporation technology that reuses process vapor as the heating medium. By
                mechanically compressing vapor to increase its temperature and pressure, MVRE
                significantly reduces steam consumption compared to conventional evaporators.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                MVRE systems are ideal for continuous ZLD operation where energy optimization is
                critical. The technology achieves high water recovery with substantially lower
                operating costs compared to traditional multi-effect evaporators, making it the
                preferred choice for industries with high wastewater volumes.
              </p>
              ...
              <div className="mb-8">
                <h3 className="text-lg font-bold text-[#142A33] mb-3">Applications</h3>
                <div className="space-y-2">
                  {applications.map((app) => (
                    <div key={app} className="flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-gradient-to-r from-[#20B0E0] to-[#8CC63F] flex-shrink-0" />
                      <span className="text-[#3C4D57] text-base">{app}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need an MVRE Evaporator System?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver an energy-efficient Mechanical Vapor
                Recompression Evaporator optimized for your ZLD and wastewater concentration
                needs.
              </p>
