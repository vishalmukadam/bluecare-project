...
const stats = [
  { value: "150+", label: "RO Systems Delivered", icon: <Recycle className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99.7%", label: "Salt Rejection Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "85%+", label: "Water Recovery Rate", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
...
const keyFeatures = [
  {
    title: "Two or More RO Stages",
    description: "Progressive salt removal with optimized recovery at each stage.",
    color: "#20B0E0",
  },
  {
    title: "High-Efficiency Spiral-Wound Membranes",
    description: "Superior salt rejection and permeate quality.",
    color: "#0E84B8",
  },
  {
    title: "Automated Control & Monitoring",
    description: "Online monitoring with modular skid-mounted design.",
    color: "#8CC63F",
  },
  {
    title: "Flexible Configuration",
    description: "Customized based on feed water quality and recovery targets.",
    color: "#E0B040",
  },
];
...
export default function MultiStageROPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Multi Stage RO System</span>
          </motion.nav>
          ...
          >
            Multi Stage{" "}<span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">RO</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/multi-stage-ro-content.avif" type="image/avif" />
                  <source srcSet="/multi-stage-ro-content.webp" type="image/webp" />
                  <img
                    src="/multi-stage-ro-content.png"
                    alt="Multi Stage RO system for progressive salt removal and high water recovery"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">RO Systems Delivered</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Multi Stage RO</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Progressive Salt Removal for{" "}
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Multistage Reverse Osmosis (RO) System is an advanced membrane-based water
                treatment solution designed to progressively remove dissolved salts and contaminants
                through two or more RO stages. In a multistage RO system, the permeate and reject
                streams are strategically routed through multiple RO stages, each designed to handle
                increasing salinity and osmotic pressure.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                This approach minimizes membrane fouling, optimizes pressure requirements, and
                enhances overall system reliability for{" "}
                <strong className="text-[#142A33]">industrial water treatment and wastewater recycling</strong>.
              </p>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Multi Stage RO Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a custom multistage RO system for higher recovery,
                better permeate quality, and optimized efficiency.
              </p>
