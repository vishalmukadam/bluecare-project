...
const stats = [
  { value: "100+", label: "Aspirator Systems Installed", icon: <Waves className="w-5 h-5" />, color: "#20B0E0" },
  { value: "95%+", label: "Oxygen Transfer Efficiency", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "50%", label: "Lower Operating Costs", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
