...
const stats = [
  { value: "50+", label: "Dryer Systems Installed", icon: <Waves className="w-5 h-5" />, color: "#20B0E0" },
  { value: "90%+", label: "Moisture Reduction", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "40%", label: "Energy Savings vs Direct", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
...
const keyBenefits = [
  {
    ...
    description: "Low operational cost and energy-efficient indirect heat transfer.",
    color: "#20B0E0",
  },
  {
    title: "Compact Design",
    description: "Minimal footprint, ideal for retrofits and space-constrained facilities.",
    color: "#0E84B8",
  },
  {
    title: "Uniform Drying",
    description: "Consistent moisture reduction and output quality.",
    color: "#8CC63F",
  },
  {
    title: "Versatile Output",
    description: "Produces dry solids suitable for safe disposal, incineration, or reuse as fuel/landfill cover.",
    color: "#E0B040",
  },
];
...
export default function PaddleDryerPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Paddle Dryer System</span>
          </motion.nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/paddle-dryer-content.avif" type="image/avif" />
                  <source srcSet="/paddle-dryer-content.webp" type="image/webp" />
                  <img
                    src="/paddle-dryer-content.png"
                    alt="Paddle Dryer System for sludge drying"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">Dryer Systems Installed</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Paddle Dryer</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                High-Performance Thermal Drying for{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">
                  Sludge Management
                </span>
              </h2>
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Paddle Dryer System is a high-performance thermal drying solution for drying
                dewatered sludge, turning wet semi-solids into dry, manageable materials with reduced
                moisture content. This indirect heat transfer system uses heated hollow paddles to
                efficiently dry sludge without direct combustion, ensuring uniform moisture reduction
                and consistent output.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Our paddle dryer systems are designed for energy efficiency and reliability, producing
                dry solids suitable for{" "}
                <strong className="text-[#142A33]">safe disposal, incineration, or reuse</strong>.
              </p>
                ...
                {keyBenefits.map((benefit) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="text-[#3C4D57] text-base"> — {benefit.description}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Paddle Dryer Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a high-performance paddle dryer system for efficient
                sludge drying and reduced operational costs.
              </p>
