...
const stats = [
  { value: "20,000", label: "Sq.Ft Manufacturing Area", icon: <Factory className="w-5 h-5" />, color: "#20B0E0" },
  { value: "100+", label: "Systems Delivered", icon: <Cog className="w-5 h-5" />, color: "#8CC63F" },
  { value: "5", label: "Core Capabilities", icon: <Wrench className="w-5 h-5" />, color: "#0E84B8" },
  { value: "98%", label: "Quality Compliance", icon: <Shield className="w-5 h-5" />, color: "#E0B040" },
];
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#8CC63F] to-[#5A9A20] flex items-center justify-center">
                    <Factory className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">20,000</p>
                    <p className="text-xs text-[#3C4D57]">Sq.Ft Facility</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
              <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-[#8CC63F]/20 rounded-2xl -z-10" />
            </motion.div>
