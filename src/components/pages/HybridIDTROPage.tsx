...
const stats = [
  { value: "50+", label: "Hybrid Systems Installed", icon: <Recycle className="w-5 h-5" />, color: "#20B0E0" },
  { value: "90%+", label: "Overall Recovery Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "40%", label: "Lower ZLD Operating Costs", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
...
const keyFeatures = [
  {
    title: "Spiral-Wound + IDT RO Combination",
    description: "Combines strengths of both membrane technologies for maximum recovery.",
    color: "#20B0E0",
  },
  {
    title: "High-TDS & High-Recovery Design",
    description: "Engineered for challenging wastewater streams where conventional RO is insufficient.",
    color: "#0E84B8",
  },
  {
    title: "Enhanced Turbulence & Reduced Fouling",
    description: "Open-channel design minimizes scaling and extends membrane life.",
    color: "#8CC63F",
  },
  {
    title: "ZLD-Compatible Architecture",
    description: "Modular, skid-mounted, fully automated for seamless integration.",
    color: "#E0B040",
  },
];
...
export default function HybridIDTROPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Hybrid IDT RO System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">Hybrid</span>{" "}IDT RO System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/hybrid-idt-ro-content.png"
                  alt="Hybrid IDT RO system combining spiral-wound and disc-tube membrane technologies"
                  width={1024}
                  height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">Hybrid Systems</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Hybrid IDT RO</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Combined Membrane Technology for{" "}
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                In a Hybrid IDT RO system, wastewater is treated through multiple RO stages using a
                combination of membrane configurations. The system efficiently processes progressively
                increasing TDS levels, enabling higher overall recovery before the concentrate is
                sent to thermal treatment.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                The hybrid approach allows the system to operate at higher pressures, handle elevated
                salinity and fouling loads, and maintain stable membrane performance — ideal for{" "}
                <strong className="text-[#142A33]">ZLD applications</strong>.
              </p>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Hybrid IDT RO Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a hybrid IDT RO system that combines the best of
                both membrane technologies for maximum water recovery.
              </p>
