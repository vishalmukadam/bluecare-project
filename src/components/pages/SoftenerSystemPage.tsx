...
const keyFeatures = [
  {
    title: "Automatic Resin Regeneration",
    description: "Uninterrupted soft water supply.",
    color: "#20B0E0",
  },
  {
    title: "High-Capacity Resin Beds",
    description: "Tailored to flow and hardness levels.",
    color: "#0E84B8",
  },
  {
    title: "Fully Automated Control Valves",
    description: "Precision operation.",
    color: "#8CC63F",
  },
];
...
const benefits = [
  { text: "Prevents scaling and corrosion", color: "#20B0E0" },
  { text: "Lowers chemical and maintenance costs", color: "#8CC63F" },
  { text: "Optimizes efficiency of boilers and cooling systems", color: "#0E84B8" },
];

/* ─────────────────────── Component ─────────────────────── */

export default function SoftenerSystemPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Softener System</span>
          </motion.nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/softener-system.webp"
                  alt="Ion-exchange water softener system installation"
                  width={1024}
                  height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">300+</p>
                    <p className="text-xs text-[#3C4D57]">Softener Systems</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#0E84B8]/10 rounded-full px-4 py-1.5 mb-5">
                <Settings className="w-4 h-4 text-[#0E84B8]" />
                <span className="text-[#0E84B8] text-sm font-semibold">About Softener Systems</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Ion-Exchange{"  "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0E84B8] to-[#8CC63F]">
                  Water Softening
                </span>
              </h2>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Hard water, rich in calcium and magnesium, leads to scale formation in boilers,
                heat exchangers, and pipelines. Our water softener systems use ion-exchange
                technology to reduce hardness, ensuring smooth operations and minimal maintenance.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Our softener systems optimize efficiency of{" "}
                <strong className="text-[#142A33]">boilers and cooling systems</strong> — a
                standard benefit in industrial water treatment solutions.
              </p>

              {/* Key Features */}
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-[#142A33] mb-4">Key Features</h3>
                <div className="space-y-3">
                  {keyFeatures.map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-3">
                      ...
                      />
                      <div>
                        <span className="font-semibold text-[#142A33]">{feature.title}</span>
                        {" — "}
                        <span className="text-[#3C4D57]">{feature.description}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {/* Benefits */}
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-[#142A33] mb-4">Benefits</h3>
                <div className="space-y-3">
                  {benefits.map((benefit, idx) => (
                    <div key={idx} className="flex items-center gap-3">
                      ...
                      />
                      <span className="text-[#3C4D57]">{benefit.text}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <div className="relative z-10 text-center">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#0E84B8] to-[#8CC63F] flex items-center justify-center mx-auto mb-6 shadow-lg">
              ...
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our experts design and deliver the perfect water softener system to protect
                your equipment and optimize your operations.
              </p>
