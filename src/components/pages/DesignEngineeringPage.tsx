...
const stats = [
  { value: "100+", label: "Projects Engineered", icon: <Award className="w-5 h-5" />, color: "#20B0E0" },
  { value: "50+", label: "Expert Engineers", icon: <Users className="w-5 h-5" />, color: "#8CC63F" },
  { value: "5", label: "Engineering Disciplines", icon: <Ruler className="w-5 h-5" />, color: "#0E84B8" },
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">Expert Engineers</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
