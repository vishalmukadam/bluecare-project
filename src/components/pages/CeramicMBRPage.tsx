...
const stats = [
  { value: "75+", label: "Ceramic MBR Installations", icon: <Waves className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99.9%", label: "Solid Removal Efficiency", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "2x", label: "Longer Membrane Life", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
...
const advantages = [
  {
    title: "Exceptional Removal of Contaminants",
    description: "Removes suspended solids, BOD, and pathogens with superior efficiency.",
    color: "#20B0E0",
  },
  {
    title: "Robust & Long-lasting Membranes",
    description: "Ceramic membranes offer extended service life and withstand aggressive cleaning.",
    color: "#0E84B8",
  },
  {
    title: "Compact Footprint",
    description: "Ideal for space-constrained installations without compromising performance.",
    color: "#8CC63F",
  },
  {
    title: "Superior Effluent Quality",
    description: "Produces water suitable for reuse in process water, cooling, or irrigation.",
    color: "#E0B040",
  },
];
...
export default function CeramicMBRPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Ceramic MBR System</span>
          </motion.nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/ceramic-mbr-content.avif" type="image/avif" />
                  <source srcSet="/ceramic-mbr-content.webp" type="image/webp" />
                  <img
                    src="/ceramic-mbr-content.png"
                    alt="Ceramic MBR system for wastewater treatment"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">75+</p>
                    <p className="text-xs text-[#3C4D57]">MBR Installations</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Ceramic MBR</span>
              </div>
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Ceramic Membrane Bioreactor (MBR) is an advanced wastewater treatment system that
                combines biological degradation with ceramic membrane filtration, offering enhanced
                durability and performance. Compared to polymeric membranes, ceramic membranes withstand
                higher temperatures and aggressive cleaning without compromising stability.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Our ceramic MBR systems deliver exceptional treatment results with a{" "}
                <strong className="text-[#142A33]">compact footprint</strong>, making them ideal for
              ...
              <div className="space-y-3 mb-8">
                {advantages.map((advantage) => (
                  ...
                  >
                    ...
                    >
                      <CheckCircle className="w-4 h-4" style={{ color: advantage.color }} />
                    </div>
                    <div>
                      <span className="text-[#142A33] text-base font-semibold group-hover:text-[#0E84B8] transition-colors duration-200">
                        {advantage.title}
                      </span>
                      <span className="text-[#3C4D57] text-base"> — {advantage.description}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Ceramic MBR Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver an advanced ceramic MBR system for superior effluent
