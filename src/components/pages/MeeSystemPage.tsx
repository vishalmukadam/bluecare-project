...
const stats = [
  { value: "100+", label: "MEE Systems Installed", icon: <Flame className="w-5 h-5" />, color: "#20B0E0" },
  { value: "90%", label: "Volume Reduction", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "200+", label: "MLD Evaporated", icon: <Droplets className="w-5 h-5" />, color: "#0E84B8" },
  { value: "7", label: "Maximum Effects", icon: <Award className="w-5 h-5" />, color: "#E0B040" },
];
...
const keyFeatures = [
  {
    title: "High Concentration Ratio",
    description: "Multiple effects enable up to 90% volume reduction of wastewater",
    color: "#20B0E0",
  },
  {
    title: "Optimized Steam Consumption",
    description: "Vapor reuse across effects significantly reduces energy costs",
    color: "#0E84B8",
  },
  {
    title: "Scalable from 1 to 7 Effects",
    description: "Configurable based on effluent volume and TDS levels",
    color: "#8CC63F",
  },
  {
    title: "Continuous and Automated Operation",
    description: "PLC-based controls for unattended, reliable performance",
    color: "#E0B040",
  },
  {
    title: "Robust Construction for Corrosive Waste",
    description: "Material options including SS316L, titanium, and Hastelloy",
    color: "#20B0E0",
  },
  {
    title: "Integrated with ZLD Process",
    description: "Seamlessly connects with RO, MVRE, and ATFD systems",
    color: "#0E84B8",
  },
];
...
export default function MeeSystemPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">MEE System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">MEE</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/mee-system-content.avif" type="image/avif" />
                  <source srcSet="/mee-system-content.webp" type="image/webp" />
                  <img
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">100+</p>
                    <p className="text-xs text-[#3C4D57]">MEE Systems Installed</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                <Flame className="w-4 h-4 text-[#20B0E0]" />
                <span className="text-[#0E84B8] text-sm font-semibold">About Our MEE System</span>
              </div>
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Multi Effect Evaporator (MEE) is a proven thermal evaporation technology that
                uses multiple stages to concentrate industrial wastewater efficiently. By reusing
                vapor from one effect as the heating medium for the next, MEE achieves high
                concentration ratios with optimized steam consumption.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                MEE systems are widely used in ZLD applications to concentrate RO reject and
                high-TDS wastewater before final drying in ATFD. Bluecare designs and manufactures
                MEE systems with 1 to 7 effects, depending on the effluent characteristics and
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need an MEE Evaporator System?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a Multi Effect Evaporator system optimized for
                your wastewater concentration needs and ZLD compliance.
              </p>
