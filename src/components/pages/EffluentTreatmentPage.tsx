...
const stats = [
  { value: "150+", label: "ETP Systems Delivered", icon: <Waves className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99.5%", label: "Compliance Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "50+", label: "Industries Served", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
...
const coreFeatures = [
  {
    title: "Screening and Equalization",
    description: "Removes large solids and balances flow",
    color: "#20B0E0",
  },
  {
    title: "Primary Treatment",
    description: "Physical and chemical separation of suspended solids",
    color: "#0E84B8",
  },
  {
    title: "Secondary Treatment",
    description: "Biological degradation of organic waste",
    color: "#8CC63F",
  },
  {
    title: "Tertiary Polishing",
    description: "Filtration, disinfection (UV/Chlorination), or advanced processes for higher quality effluent",
    color: "#E0B040",
  },
];
...
export default function EffluentTreatmentPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFE]">
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Effluent Treatment Plant</span>
          </motion.nav>
      ...
      {/* ─── About Effluent Treatment Section ─── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/effluent-treatment-content.avif" type="image/avif" />
                  <source srcSet="/effluent-treatment-content.webp" type="image/webp" />
                  <img
                    src="/effluent-treatment-content.png"
                    alt="Industrial effluent treatment plant system"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">ETP Systems Delivered</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Our ETP Solutions</span>
              </div>
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Effluent Treatment Plants are engineered systems that treat industrial wastewater
                containing chemicals, organics, oils, and heavy metals prior to discharge or reuse. We
                tailor ETP designs for diverse industries such as pharmaceuticals, textiles, chemicals,
                food &amp; beverage, and more.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Our multi-stage treatment approach ensures complete compliance with environmental
                regulations while enabling water reuse and recycling in industrial processes.
              </p>
              ...
              {/* Benefits */}
              <div className="bg-gradient-to-r from-[#20B0E0]/5 to-[#8CC63F]/5 rounded-xl p-5 mb-8 border border-[#20B0E0]/10">
                <p className="text-[#142A33] font-semibold text-sm mb-3">Key Benefits</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2 text-[#3C4D57] text-sm">
                    <CheckCircle className="w-4 h-4 text-[#8CC63F] flex-shrink-0 mt-0.5" />
                    <span>Ensures compliance with environmental regulations.</span>
                  </li>
                  <li className="flex items-start gap-2 text-[#3C4D57] text-sm">
                    <CheckCircle className="w-4 h-4 text-[#8CC63F] flex-shrink-0 mt-0.5" />
                    <span>Reduces environmental impact and supports sustainable operations.</span>
                  </li>
                  <li className="flex items-start gap-2 text-[#3C4D57] text-sm">
                    <CheckCircle className="w-4 h-4 text-[#8CC63F] flex-shrink-0 mt-0.5" />
                    <span>Enables water reuse and recycling in industrial processes.</span>
                  </li>
                </ul>
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need an Effluent Treatment Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver the perfect ETP system to treat industrial wastewater,
                ensure regulatory compliance, and enable water reuse.
              </p>
