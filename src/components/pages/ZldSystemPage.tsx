...
const stats = [
  { value: "150+", label: "ZLD Systems Installed", icon: <Zap className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99%", label: "Water Recovery Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "500+", label: "MLD Water Treated", icon: <Droplets className="w-5 h-5" />, color: "#0E84B8" },
...
const keyFeatures = [
  {
    title: "Comprehensive Zero Liquid Discharge Solutions",
    description: "End-to-end process coverage from pretreatment to solids recovery",
    color: "#20B0E0",
  },
  {
    title: "End-to-End Turnkey Approach",
    description: "Single-source responsibility from design through commissioning",
    color: "#0E84B8",
  },
  {
    title: "Customized Treatment Based on Effluent Quality",
    description: "Tailored solutions matched to your specific wastewater characteristics",
    color: "#8CC63F",
  },
  {
    title: "Optimized Multi-Stage Purification",
    description: "Advanced RO, evaporation, and drying for maximum water recovery",
    color: "#E0B040",
  },
  {
    title: "Reliable Performance with Minimal Intervention",
    description: "Automated controls and robust system design",
    color: "#20B0E0",
  },
  {
    title: "Economical and Sustainable Water Recovery",
    description: "Cost-effective operations with environmental compliance",
    color: "#8CC63F",
  },
];
...
export default function ZldSystemPage() {
  return (
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">ZLD System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">ZLD</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/zld-system-content.avif" type="image/avif" />
                  <source srcSet="/zld-system-content.webp" type="image/webp" />
                  <img
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">150+</p>
                    <p className="text-xs text-[#3C4D57]">ZLD Systems Installed</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Our ZLD System</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Complete Zero Liquid{" "}
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Bluecare offers well designed ZLD system to minimize the volume of waste water that
                requires treatment, process wastewater in an economically feasible manner, while also
                producing a clean stream suitable for reuse elsewhere in the facility.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Bluecare provides a turnkey solution for Zero Liquid Discharge, which includes the
                process like primary treatment, secondary treatment, tertiary treatment, reverse
                osmosis multi-stage system, evaporation system and ATFD. Based on the effluent
                characteristics Bluecare will select the process of treatment to recycle water to
                process industries and other facilities in plant.
              </p>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a ZLD System Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a comprehensive Zero Liquid Discharge system tailored
                to your effluent characteristics and regulatory requirements.
              </p>
