...
const stats = [
  { value: "75+", label: "IDT RO Systems Installed", icon: <Recycle className="w-5 h-5" />, color: "#20B0E0" },
  { value: "95%+", label: "Recovery Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "1200+", label: "bar Operating Pressure", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">IDT RO Systems</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
