...
const stats = [
  { value: "100+", label: "Systems Commissioned", icon: <Headphones className="w-5 h-5" />, color: "#20B0E0" },
  { value: "50+", label: "Expert Technicians", icon: <Users className="w-5 h-5" />, color: "#8CC63F" },
  { value: "24/7", label: "Service Availability", icon: <Clock className="w-5 h-5" />, color: "#0E84B8" },
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#0E84B8] to-[#20B0E0] flex items-center justify-center">
                    <Headphones className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">100+</p>
                    <p className="text-xs text-[#3C4D57]">Systems Commissioned</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
              <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-[#0E84B8]/20 rounded-2xl -z-10" />
            </motion.div>
