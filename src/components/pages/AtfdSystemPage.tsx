...
const stats = [
  { value: "70+", label: "ATFD Systems Installed", icon: <Zap className="w-5 h-5" />, color: "#20B0E0" },
  { value: "95%", label: "Moisture Removal", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "50+", label: "Industries Served", icon: <Droplets className="w-5 h-5" />, color: "#0E84B8" },
  { value: "100%", label: "ZLD Compliance", icon: <Award className="w-5 h-5" />, color: "#E0B040" },
];
...
const keyFeatures = [
  {
    title: "Efficient Drying of High-Salt Slurry and Concentrated Waste",
    description: "Handles MEE/MVRE concentrate with ease",
    color: "#20B0E0",
  },
  {
    title: "Continuous Operation with Uniform Heat Transfer",
    description: "Thin film formation ensures consistent drying quality",
    color: "#0E84B8",
  },
  {
    title: "Produces Dry, Free-Flowing Solids",
    description: "Output ready for landfill or authorized disposal",
    color: "#8CC63F",
  },
  {
    title: "Compact Design Suitable for Industrial Environments",
    description: "Space-efficient installation in existing facilities",
    color: "#E0B040",
  },
  {
    title: "Eliminates Liquid Waste Discharge",
    description: "Final step to achieve true zero liquid discharge",
    color: "#20B0E0",
  },
  {
    title: "Reduces Waste Volume and Disposal Cost",
    description: "Dramatic volume reduction from slurry to dry powder",
    color: "#0E84B8",
  },
];

/* ─────────────────────── Why Choose Bluecare ZLD ─────────────────────── */

const whyChooseZLD = [
  "Customized ZLD solutions based on wastewater characteristics",
  "Integration of membrane and thermal technologies for optimal recovery",
  "Energy-efficient MEE and MVRE designs",
  "Reliable solids handling with ATFD systems",
  "Turnkey execution from design to commissioning",
  "Compliance with CPCB, SPCB, and global environmental standards",
];

/* ─────────────────────── Component ─────────────────────── */

export default function AtfdSystemPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFE]">
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#3C4D57]/60">ZLD System</span>
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">ATFD System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">ATFD</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/atfd-system-content.avif" type="image/avif" />
                  <source srcSet="/atfd-system-content.webp" type="image/webp" />
                  <img
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">70+</p>
                    <p className="text-xs text-[#3C4D57]">ATFD Systems Installed</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                <Zap className="w-4 h-4 text-[#20B0E0]" />
                <span className="text-[#0E84B8] text-sm font-semibold">About Our ATFD System</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Final-Stage Drying for{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">
                  Complete ZLD Compliance
                </span>
              </h2>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Agitated Thin Film Dryer (ATFD) is the final stage in a ZLD system, used to
                convert concentrated effluent or slurry into dry solid residue. ATFD uses indirect
                heating and continuous agitation to form a thin film, ensuring rapid moisture
                evaporation and uniform drying.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                ATFD systems from Bluecare are engineered to handle high-salt and hazardous waste
                streams from MEE and MVRE concentrate. The result is dry, free-flowing solids
                suitable for landfill or authorized disposal, ensuring complete compliance with ZLD
                norms and CPCB/SPCB regulations.
              </p>
      ...
      {/* ─── Why Choose Bluecare ZLD Systems Section ─── */}
      <section className="py-16 md:py-20 relative overflow-hidden bg-white">
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-80 h-80 bg-[#0E84B8]/5 rounded-full blur-3xl -translate-y-1/3 -translate-x-1/3" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#8CC63F]/10 rounded-full px-4 py-1.5 mb-4">
              <Zap className="w-4 h-4 text-[#8CC63F]" />
              <span className="text-[#0E84B8] text-sm font-semibold">ZLD System Expertise</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-3">
              Why Choose Bluecare{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">
                ZLD Systems
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            {whyChooseZLD.map((item, i) => (
              <motion.div
                ...
                custom={i}
                className="flex items-start gap-3 bg-[#F8FAFE] rounded-xl p-5 border border-[#E2E8F0]/60 group hover:shadow-md transition-shadow duration-300"
              >
                <div className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 bg-[#8CC63F]/15">
                  <CheckCircle className="w-4 h-4 text-[#8CC63F]" />
                </div>
                <span className="text-[#3C4D57] text-base leading-relaxed group-hover:text-[#142A33] transition-colors duration-200">
                  {item}
                </span>
              </motion.div>
            ))}
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need an ATFD Drying System?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver an Agitated Thin Film Dryer system for complete ZLD
                compliance and efficient solids recovery from your wastewater concentrate.
              </p>
