...
const stats = [
  { value: "100+", label: "UF Systems Installed", icon: <Recycle className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99.9%", label: "Solid Removal Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "50%", label: "Lower Energy vs Pressurized UF", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
...
const keyFeatures = [
  {
    title: "Low-Pressure Membrane Filtration",
    description: "Gentle suction operation with lower energy consumption.",
    color: "#20B0E0",
  },
  {
    title: "Hollow Fiber / Flat-Sheet Membranes",
    description: "High solids tolerance with automatic backwash and CIP.",
    color: "#0E84B8",
  },
  {
    title: "Continuous Air Scouring",
    description: "Prevents fouling by keeping membrane surface clean.",
    color: "#8CC63F",
  },
  {
    title: "Compact & Modular Design",
    description: "Smaller footprint compared to conventional tertiary systems.",
    color: "#E0B040",
  },
];
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">UF System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">UF</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/uf-system-content.avif" type="image/avif" />
                  <source srcSet="/uf-system-content.webp" type="image/webp" />
                  <img
                    src="/uf-system-content.png"
                    alt="Submerged UF system for water recycling"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#3C4D57]">UF Systems Installed</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Our UF System</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Advanced Membrane Filtration for{" "}
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                The Submerged Ultrafiltration (UF) System is an advanced membrane filtration technology
                in which UF membrane modules are immersed directly in a feed tank or membrane basin.
                Submerged UF systems operate under low trans-membrane pressure, using gentle suction to
                draw water through the membranes while retaining suspended solids, colloids, bacteria,
                and pathogens.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                This configuration provides stable operation even with variable feed quality, making it
                ideal for{" "}
                <strong className="text-[#142A33]">wastewater recycling applications</strong>.
              </p>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a UF System Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a custom submerged UF system for reliable water reuse,
                recycling, and downstream RO protection.
              </p>
