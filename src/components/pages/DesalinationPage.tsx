...
const keyFeatures = [
  {
    title: "High-Efficiency RO Membranes",
    description: "Salt rejection up to 99% with consistent permeate quality.",
    color: "#20B0E0",
  },
  {
    title: "Custom Pre-Treatment",
    description: "Protects membrane integrity and performance in diverse feed conditions.",
    color: "#0E84B8",
  },
  {
    title: "Energy Recovery Systems",
    description: "Enhanced efficiency and reduced operating costs for sustainable operation.",
    color: "#8CC63F",
  },
  {
    title: "Scalable Design",
    description: "From small plants to large community desalination projects.",
    color: "#E0B040",
  },
];
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Desalination System</span>
          </motion.nav>
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">Desalination</span>{" "}System
          </motion.h1>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">60+</p>
                    <p className="text-xs text-[#3C4D57]">Desalination Plants</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Desalination systems are specialized RO-based solutions engineered to remove dissolved
                salts and minerals from high-TDS sources — including seawater, brackish water, and
                saline wastewater. With high-efficiency RO membranes delivering salt rejection up to
                99%, these systems make water suitable for reuse or potable applications.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Custom pre-treatment protects membrane integrity, while{" "}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
                {keyFeatures.map((feature, i) => (
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className="font-semibold text-[#142A33] text-sm">{feature.title}</p>
                      <p className="text-[#3C4D57]/70 text-sm">{feature.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Desalination Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver a custom desalination system to convert saline and
                brackish water into reusable freshwater for industrial or potable use.
              </p>
