...
const stats = [
  { value: "1000+", label: "RO Systems Delivered", icon: <Droplets className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99.9%", label: "Salt Rejection Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "200+", label: "MLD Water Purified", icon: <Waves className="w-5 h-5" />, color: "#0E84B8" },
  { value: "40%", label: "Energy Savings", icon: <Zap className="w-5 h-5" />, color: "#E0B040" },
];
...
const checklistItems = [
  {
    title: "High TDS Rejection",
    description: "Energy-efficient membranes for superior salt removal.",
    color: "#20B0E0",
  },
  {
    title: "Automated Control Systems",
    description: "Optimum flux and minimal membrane fouling.",
    color: "#0E84B8",
  },
  {
    title: "Scalable Configurations",
    description: "From small commercial units to large industrial capacities.",
    color: "#8CC63F",
  },
  {
    title: "High Recovery Options",
    description: "Reduce waste and operating costs.",
    color: "#E0B040",
  },
];
...
const applications = [
  { text: "Process water for manufacturing and electronics", color: "#20B0E0" },
  { text: "Boiler feed water with reduced scaling risk", color: "#0E84B8" },
  { text: "Drinking water purification for commercial facilities", color: "#8CC63F" },
  { text: "Pre-treatment before EDI systems to achieve ultra-purity", color: "#E0B040" },
];
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">RO System</span>
          </motion.nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/ro-system.webp"
                  alt="RO system with advanced membrane technology for water treatment"
                  width={1024}
                  height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">1000+</p>
                    <p className="text-xs text-[#3C4D57]">RO Systems</p>
                  </div>
                </div>
              </div>
              {/* Decorative accent */}
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                <Cog className="w-4 h-4 text-[#20B0E0]" />
                <span className="text-[#0E84B8] text-sm font-semibold">About Our RO Systems</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Advanced Membrane{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#0E84B8]">
                  Purification
                </span>
              </h2>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Reverse osmosis is the industry benchmark for removing dissolved solids, salts, and
                microscopic contaminants. Our RO plants incorporate advanced membrane technology to
                produce high-quality water suitable for both industrial processes and high-purity
                applications.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Our RO systems feature{" "}
                <strong className="text-[#142A33]">
                  high TDS rejection with energy-efficient membranes
                </strong>{" "}
                and automated control systems for optimum flux and minimal membrane fouling —
                delivering reliable performance across all industrial applications.
              </p>

              {/* What Sets Our RO Systems Apart */}
              <div className="mb-8">
                <h3 className="text-lg font-bold text-[#142A33] mb-4">
                  What Sets Our RO Systems Apart
                </h3>
                <div className="space-y-3">
                  {checklistItems.map((item) => (
                    <div key={item.title} className="flex items-start gap-3">
                      ...
                      />
                      <div>
                        <span className="font-semibold text-[#142A33]">{item.title}</span>
                        <span className="text-[#3C4D57]"> — {item.description}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2.5">
                  {applications.map((app) => (
                    <div key={app.text} className="flex items-center gap-3">
                      <CheckCircle
                        className="w-4 h-4 flex-shrink-0"
                        style={{ color: app.color }}
                      />
                      <span className="text-[#3C4D57]">{app.text}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver the perfect reverse osmosis solution for your
                water treatment needs — from process water to ultra-pure applications.
              </p>
