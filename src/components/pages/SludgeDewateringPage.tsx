...
const stats = [
  { value: "120+", label: "Dewatering Systems Installed", icon: <Waves className="w-5 h-5" />, color: "#20B0E0" },
  { value: "80%", label: "Moisture Reduction", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "50%", label: "Volume Reduction", icon: <Award className="w-5 h-5" />, color: "#0E84B8" },
  { value: "98%", label: "Client Satisfaction", icon: <Users className="w-5 h-5" />, color: "#E0B040" },
];

/* ─────────────────────── Sludge Dewatering Methods ─────────────────────── */

const dewateringMethods = [
  {
    title: "Filter Press",
    description: "High-pressure dewatering for dense solids.",
    color: "#20B0E0",
  },
  {
    title: "Decanter / Screw Press",
    description: "Continuous dewatering suitable for large volumes.",
    color: "#0E84B8",
  },
  {
    title: "Belt Press",
    description: "Continuous mechanical dewatering with low energy consumption.",
    color: "#8CC63F",
  },
  {
    title: "Centrifuge System",
    description: "High-speed rotational dewatering for maximum dryness.",
    color: "#E0B040",
  },
];
...
export default function SludgeDewateringPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFE]">
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Sludge Dewatering System</span>
          </motion.nav>
      ...
      {/* ─── About Sludge Dewatering Section ─── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/sludge-dewatering-content.avif" type="image/avif" />
                  <source srcSet="/sludge-dewatering-content.webp" type="image/webp" />
                  <img
                    src="/sludge-dewatering-content.png"
                    alt="Industrial sludge dewatering system for wastewater treatment"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">120+</p>
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Sludge Dewatering</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Efficient Sludge Volume Reduction for{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Sludge dewatering is the process of removing water from sludge, the semi-solid
                by-product generated during wastewater treatment. Dewatering significantly reduces
                volume and weight, making handling, transport, and disposal more cost-effective.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                Our dewatering solutions are engineered for reliability and performance, offering
                both{" "}
                <strong className="text-[#142A33]">batch and continuous processing</strong>{" "}
                options.
              </p>

              {/* Key Methods checklist */}
              <div className="space-y-3 mb-8">
                {dewateringMethods.map((method) => (
                  <div
                    key={method.title}
                  ...
                  >
                    ...
                    >
                      <CheckCircle className="w-4 h-4" style={{ color: method.color }} />
                    </div>
                    <div>
                      <span className="text-[#142A33] text-base font-semibold group-hover:text-[#0E84B8] transition-colors duration-200">
                        {method.title}
                      </span>
                      <span className="text-[#3C4D57] text-base"> — {method.description}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Sludge Dewatering Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver the perfect sludge dewatering system to reduce
                volume, lower disposal costs, and improve downstream processing.
              </p>
