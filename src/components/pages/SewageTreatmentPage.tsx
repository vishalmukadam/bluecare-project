...
const stats = [
  { value: "200+", label: "STP Systems Installed", icon: <Waves className="w-5 h-5" />, color: "#20B0E0" },
  { value: "99%", label: "Pollutant Removal Rate", icon: <Shield className="w-5 h-5" />, color: "#8CC63F" },
  { value: "100+", label: "MLD Water Treated", icon: <Droplets className="w-5 h-5" />, color: "#0E84B8" },
  { value: "98%", label: "Client Satisfaction", icon: <Award className="w-5 h-5" />, color: "#E0B040" },
];
...
const keyTechnologies = [
  {
    ...
    description: "Compact, biofilm-based system with high organic removal efficiency.",
    color: "#20B0E0",
  },
  {
    title: "Sequential Batch Reactor (SBR)",
    description: "Batch-based aeration and settling for flexible load handling.",
    color: "#0E84B8",
  },
  {
    title: "Membrane Bioreactor (MBR)",
    description: "Combines biological degradation with membrane filtration for superior effluent quality suitable for reuse.",
    color: "#8CC63F",
  },
  {
    title: "Activated Sludge Process (ASP)",
    description: "Tried-and-tested process for large wastewater volumes.",
    color: "#E0B040",
  },
];
...
export default function SewageTreatmentPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFE]">
      ...
      <section className="relative h-[250px] overflow-hidden mt-20 bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center text-center">
          ...
          >
            ...
            <ChevronRight className="w-3.5 h-3.5" />
            <span className="text-[#20B0E0] font-medium">Sewage Treatment Plant</span>
          </motion.nav>
      ...
      {/* ─── About Sewage Treatment Section ─── */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source srcSet="/sewage-treatment-content.avif" type="image/avif" />
                  <source srcSet="/sewage-treatment-content.webp" type="image/webp" />
                  <img
                    src="/sewage-treatment-content.png"
                    alt="Sewage treatment plant system for wastewater treatment"
                    width={1024}
                    height={1024}
              ...
              <div className="absolute -bottom-6 -right-4 md:right-6 bg-white rounded-xl shadow-xl p-4 border border-[#E2E8F0]/60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#142A33]">200+</p>
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#20B0E0]/10 rounded-full px-4 py-1.5 mb-5">
                ...
                <span className="text-[#0E84B8] text-sm font-semibold">About Our Sewage Treatment</span>
              </div>

              <h2 className="text-3xl md:text-4xl font-bold text-[#142A33] mb-6 leading-tight">
                Advanced Wastewater Treatment for a{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#20B0E0] to-[#8CC63F]">
                  Cleaner Future
                </span>
              </h2>
              ...
              <p className="text-[#3C4D57] text-lg leading-relaxed mb-5">
                Sewage Treatment Plants are designed to treat domestic and institutional wastewater
                from sources such as housing complexes, hotels, hospitals, offices, and
                municipalities. STPs remove organic pollutants, suspended solids, and pathogens
                through physical, biological, and tertiary processes.
              </p>

              <p className="text-[#3C4D57] text-lg leading-relaxed mb-8">
                We offer a range of proven technologies to ensure reliable, efficient, and
                compliant treatment for every project scale.
              </p>

              {/* Key Technologies checklist */}
              <div className="space-y-3 mb-8">
                {keyTechnologies.map((tech) => (
                  ...
                  >
                    ...
                    >
                      <CheckCircle className="w-4 h-4" style={{ color: tech.color }} />
                    </div>
                    <div>
                      <span className="text-[#142A33] text-base font-semibold group-hover:text-[#0E84B8] transition-colors duration-200">
                        {tech.title}
                      </span>
                      <span className="text-[#3C4D57] text-base"> — {tech.description}</span>
                    </div>
                  </div>
                ))}
              </div>
          ...
          >
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Need a Sewage Treatment Solution?
              </h2>
              <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                Let our team design and deliver the perfect STP system to treat domestic and
                institutional wastewater efficiently and meet CPCB/SPCB discharge standards.
              </p>
