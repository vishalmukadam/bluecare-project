          ...
          >
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="text-white/85 text-sm drop-shadow-sm max-w-[250px]">Plot No: H1-378,378-A&B, 381-B, Growth Centre, RIICO Industrial Area, Hamirgarh-311025, Dist-Bhilwara, RAJASTHAN</p>
              </div>
            </motion.div>
          </motion.div>
